...
leg = instance_create_depth(x-body.legs_pos[0],y+body.legs_pos[1],depth-1,obj_boss_leg)
leg.visible = false
legL = instance_create_depth(x-body.legs_pos[0],y+body.legs_pos[1],depth-1,leg.object_index)
legR = instance_create_depth(x+body.legs_pos[0],y+body.legs_pos[1],depth-1,leg.object_index)
legR.image_xscale = -1