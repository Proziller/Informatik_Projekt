if room == rm_home{
    draw_text_ext_transformed(16, 24, "CONTROLS: wasd to move     right click to shoot        left click to dash          drag any gun into a slot to put it there", 20, 200, 1.5, 1.5, 0)
